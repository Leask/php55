...
#define PEAR_INSTALLDIR         "/usr/local/Cellar/php55/5.5.1/lib/php"
#define PHP_INCLUDE_PATH	".:/usr/local/Cellar/php55/5.5.1/lib/php"
#define PHP_EXTENSION_DIR       "/usr/local/Cellar/php55/5.5.1/lib/php/extensions/no-debug-non-zts-20121212"
#define PHP_PREFIX              "/usr/local/Cellar/php55/5.5.1"
#define PHP_BINDIR              "/usr/local/Cellar/php55/5.5.1/bin"
#define PHP_SBINDIR             "/usr/local/Cellar/php55/5.5.1/sbin"
#define PHP_MANDIR              "/usr/local/Cellar/php55/5.5.1/share/man"
#define PHP_LIBDIR              "/usr/local/Cellar/php55/5.5.1/lib/php"
